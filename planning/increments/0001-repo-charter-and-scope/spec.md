...
Define the mission, boundaries, non-goals, and neutrality rules for this protocol repository.

## User Stories

### US-001: Define the protocol mission
**Project**: agent-resource-protocol

**As a** protocol maintainer
**I want** a clear charter for this repository
